        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    ...
                    <div class="page-header-subtitle">Here are all your  Users
                    </div>
                </div>
    ...
    <div class="card mb-4">
        <div class="card-header"><div class="" style="display: flex;justify-content:space-between">
            ...
            <div class="badge bg-primary text-white rounded-pill" x-data='xlien'>
                <a x-on:click='redirect( "{{ Route('users.create') }}" )' class="text-white pointer">Add</a> 
            </div>
        </div></div>
        <div class="card-body" x-data='xdatas("users", 5)'>
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                <div class="dataTable-container">
                    <table class="dataTable-table">
                        ...
                        <tbody>
                            <template x-for='user in datas'>
                                <tr>
                                    <td x-text='ucword(user.first_name)'></td>
                                    <td x-text='ucword(user.last_name)'></td>
                                    <td x-text='ucword(user.phone)'></td>
                                    <td x-text='`${user.gender == "m" ? "Male" : "Female"}`'></td>
                                    <td>
