                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="name" type="text" placeholder="Enter Name" name="name" verify>
                        </div>

                        <div class="mb-3">
                            <label class="small mb-1" for="description">Description</label>
                            <textarea class="form-control" id="description" type="text" placeholder="Enter Description" name="description" rows="3" verify></textarea>
                        </div>
