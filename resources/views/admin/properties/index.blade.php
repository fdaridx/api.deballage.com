        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    ...
                    <div class="page-header-subtitle">Here are all your Properties
                    </div>
                </div>
    ...
    <div class="card mb-4">
        <div class="card-header"><div class="" style="display: flex;justify-content:space-between">
            ...
            <div class="badge bg-primary text-white rounded-pill" x-data='xlien'>
                <a x-on:click='redirect( "{{ Route('properties.create') }}" )' class="text-white pointer">Add</a> 
            </div>
        </div></div>
        <div class="card-body" x-data='xdatas("properties", 5)'>
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                <div class="dataTable-container">
                    <table class="dataTable-table">
                        ...
                        <tbody>
                            <template x-for='property in datas'>
                                <tr>
                                    <td x-text='ucword(property.attribute.name)'></td>
                                    <td x-text='property.value'></td>
                                    <td>
                                        <div x-on:click='redirect(property.edit_url)' class="pointer badge bg-warning text-white rounded-pill">
                                            edit</div>
                                            <div x-bind:id='property.id' x-bind:url="`properties`" onclick="del(this)" class="btn btn-datatable btn-icon btn-transparent-dark"><svg
