...
<div class="container-xl px-4 mt-n10">
    <div class="card mb-4">
        ...
        <div class="card-body" x-data='xdatas("commandes", 5)'>
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                <div class="dataTable-container">
                    <table class="dataTable-table">
                        ...
                        <tbody>
                            <template x-for='command in datas'>
                                <tr>
                                    <td x-text='ucword(command.qwater.city.name)'></td>
                                    <td x-text='ucword(`${command.user.first_name} ${command.user.last_name}`)' x-on:click='redirect(`/users/edit/${command.user.id}`)'></td>
                                    <td x-text='ucword(command.qwater.name)'></td>
                                    <td x-text='ucword(command.qwater.city.country.name)'></td>
                                    <td x-text='`payment`'></td>
