        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    ...
                    <div class="page-header-subtitle">Here are all your Attibute Products
                    </div>
                </div>
...
<div class="container-xl px-4 mt-n10">
    <div class="card mb-4">
        <div class="card-header"><div class="" style="display: flex;justify-content:space-between">
            <div>list of attribute products </div>
            <div class="badge bg-primary text-white rounded-pill" x-data='xlien'>
                <a x-on:click='redirect( "{{ Route('products.attribute_create', $product->id) }}" )' class="text-white pointer">Add</a> 
            </div>
        </div></div>
        <div class="card-body" x-data='xdatas("attributeProducts/{{ $product->id }}", 5)'>
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                <div class="dataTable-container">
                    <table class="dataTable-table">
                        ...
                        <tbody>
                            <template x-for='attribute in datas'>
                                <tr>
                                    <td x-text='ucword(attribute.name)'></td>
                                    {{-- <td>
                                        <div x-on:click='redirect(attribute.edit)' class="pointer badge bg-warning text-white rounded-pill">
                                            edit</div>
                                            <div x-bind:id='attribute.id' x-bind:url="`attributes`" onclick="del(this)" class="btn btn-datatable btn-icon btn-transparent-dark"><svg
